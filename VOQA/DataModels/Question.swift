...
class Question: ObservableObject, Decodable {
    ...
    var correctionScript: String
    var correctionScriptUrl: String
    ...
    init(id: UUID = UUID(), topicId: UUID, content: String, options: [String], correctOption: String, selectedOption: String = "", isAnswered: Bool = false, isAnsweredCorrectly: Bool, numberOfPresentations: Int = 0, ratings: Int = 0, numberOfRatings: Int = 0, audioScript: String, audioUrl: String, correctionScript: String, correctionScriptUrl: String, replayQuestionAudioScript: String, replayOptionAudioScript: String, status: QuestionStatus, difficultyLevel: Int, answerPresentedDate: Date? = nil) {
        self.id = id
        ...
        self.correctionScript = correctionScript
        self.correctionScriptUrl = correctionScriptUrl
    ...
    convenience init(id: UUID = UUID()) {
        self.init(id: id, topicId: UUID(), content: "", options: [], correctOption: "", isAnsweredCorrectly: false, audioScript: "", audioUrl: "", correctionScript: "", correctionScriptUrl: "", replayQuestionAudioScript: "", replayOptionAudioScript: "", status: .newQuestion, difficultyLevel: TopicCategory.foundational.rawValue)
    }
    
    convenience init(id: UUID = UUID(), topicId: UUID, content: String, options: [String], correctOption: String, audioScript: String, audioUrl: String, correctionScript: String, correctionScriptUrl: String, replayQuestionAudioScript: String, replayOptionAudioScript: String, topicCategory: TopicCategory) {
        self.init(id: id, topicId: topicId, content: content, options: options, correctOption: correctOption, isAnsweredCorrectly: false, audioScript: audioScript, audioUrl: audioUrl, correctionScript: correctionScript, correctionScriptUrl: correctionScriptUrl, replayQuestionAudioScript: replayQuestionAudioScript, replayOptionAudioScript: replayOptionAudioScript, status: .newQuestion, difficultyLevel: topicCategory.rawValue)
    }
    
    private enum CodingKeys: String, CodingKey {
        case id, topicId, content, options, correctOption, selectedOption, isAnswered, isAnsweredCorrectly, numberOfPresentations, ratings, numberOfRatings, audioScript, audioUrl, correctionScript, correctionScriptUrl, replayQuestionAudioScript, replayOptionAudioScript, status, difficultyLevel, answerPresentedDate
    }
    ...
    required init(from decoder: Decoder) throws {
        ...
        self.correctionScript = try container.decode(String.self, forKey: .correctionScript)
        self.correctionScriptUrl = try container.decode(String.self, forKey: .correctionScriptUrl)
