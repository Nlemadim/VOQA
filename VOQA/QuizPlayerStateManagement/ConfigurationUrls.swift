...
struct ConfigurationUrls  {
    static let sessionConfiguration = "https://ljnsun.buildship.run/voqaSessionConfiguration"
    ...
    static let downloadVoqalizedQuestions = "https://ljnsun.buildship.run/fetchVoqalizedQuestion"
}
